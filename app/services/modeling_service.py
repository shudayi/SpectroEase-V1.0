...
class ModelingService:
    ...
    def train_model_with_cv(self, model_name: str, params: dict, X: pd.DataFrame, y: pd.Series,
        ...
        Args:
            ...
            X: 特征数据
            y: 目标变量
            cv_params: 交叉验证Parameters
            hyperopt_params: 超Parameters优化Parameters
    ...
    def evaluate_model(self, model, X_test, y_test, task_type=None):
        ...
        Args:
            ...
            X_test: 测试features
            y_test: 测试labels
            task_type: Task type（可选，classification或regression）
