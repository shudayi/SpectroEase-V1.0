...
class PreprocessingView(QWidget):
    ...
    def init_ui(self):
        """Initialize preprocessing UI interface"""
        ...
        # --- Basic Tab with ScrollArea ---
        basic_tab = QWidget()
        basic_tab_layout = QVBoxLayout(basic_tab) # Layout for the tab itself
        basic_tab_layout.setContentsMargins(0, 0, 0, 0)

        scroll_basic = QScrollArea()
        scroll_basic.setWidgetResizable(True)
        
        content_widget_basic = QWidget()
        basic_layout = QVBoxLayout(content_widget_basic)
        basic_layout.setSpacing(5)
        basic_layout.setContentsMargins(5, 5, 5, 5)

        scroll_basic.setWidget(content_widget_basic)
        basic_tab_layout.addWidget(scroll_basic)
        
        # New: Spike removal group (Recommended for Raman, default closed)
        despiking_group = QGroupBox("Spike Removal (Recommended for Raman)")
        ...
        self.despiking_check.setChecked(False)  # 默认Close
        ...
        basic_layout.addStretch() # Add a stretch to push content up
        tabs.addTab(basic_tab, "Basic")
        
        # --- Advanced Tab with ScrollArea ---
        ...
        content_widget_advanced = QWidget()
        advanced_layout = QVBoxLayout(content_widget_advanced)
        ...
        advanced_layout.addStretch() # Add a stretch to push content up
        scroll_advanced.setWidget(content_widget_advanced)
        advanced_tab_layout.addWidget(scroll_advanced)
        tabs.addTab(advanced_tab, "Advanced")
        
        # --- Special Tab with ScrollArea ---
        special_tab = QWidget()
        special_tab_layout = QVBoxLayout(special_tab)
        special_tab_layout.setContentsMargins(0, 0, 0, 0)

        scroll_special = QScrollArea()
        scroll_special.setWidgetResizable(True)

        content_widget_special = QWidget()
        special_layout = QVBoxLayout(content_widget_special)
        ...
        self.wavelength_calib_check.setChecked(False)  # 默认Close
        ...
        self.intensity_calib_check.setChecked(False)  # 默认Close
        ...
        special_layout.addStretch() # Add a stretch to push content up
        scroll_special.setWidget(content_widget_special)
        special_tab_layout.addWidget(scroll_special)
