...
class MainWindow(QMainWindow):  # Define main window class, inheriting from QMainWindow
    ...
    def init_ui(self):
        ...
        basic_layout = QVBoxLayout()  # Create a vertical layout manager
        basic_layout.setSpacing(0)  # Completely remove spacing
        basic_layout.setContentsMargins(0, 0, 0, 0)  # Completely remove internal margins
        ...
        baseline_outer_layout.setSpacing(5)
        baseline_outer_layout.setContentsMargins(8, 8, 8, 8)
        ...
        baseline_form_layout.setSpacing(8)
        baseline_form_layout.setContentsMargins(0, 5, 0, 0)
        ...
        scatter_outer_layout.setSpacing(5)
        scatter_outer_layout.setContentsMargins(8, 8, 8, 8)
        ...
        smooth_outer_layout.setSpacing(5)
        smooth_outer_layout.setContentsMargins(8, 8, 8, 8)
        ...
        basic_layout.addWidget(smooth_group)    
        ...
        checkboxes = [
            self.baseline_check, self.scatter_check, self.smooth_check, 
    ...
    def setup_toolbar(self):
        ...
        undo_action.setStatusTip("English text")
        undo_action.setToolTip("English text")
    ...
    def apply_feature_selection(self):
        ...
        try:
            ...
            if 'feature_importance' in result and result['feature_importance'] is not None:
                from utils.visualization_window import VisualizationWindow
