...
class UnifiedDataProcessor:
    ...
    def get_safe_labels_for_visualization(self) -> np.ndarray:
        ...
        if self.task_type == 'regression':
            # 回归任务：直接返回Original数值标签，可视化组件会正确处理
            return self.original_labels.copy()
        else:
