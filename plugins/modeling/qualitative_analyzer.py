...
try:
    ...
    print("🔍 sklearn call tracer activated - will record all sklearn function calls")
...
class QualitativeAnalyzer:
    ...
    def _create_model(self):
        ...
        if self.method == 'kmeans':
            ...
            return SVC(
                C=10.0,                    # Increase regularization parameters, suitable for high-dimensional spectral data
            ...
            return RandomForestClassifier(
                n_estimators=300,          # increase number of trees, improve precision
            ...
            try:
                ...
                return xgb.XGBClassifier(
                    ...
                    objective='multi:softprob',    # multi-classification probability
